...
export const LampContainer = ({
    ...
    return (
        <div
            className={cn(
                "relative flex min-h-[300px] flex-col items-center justify-center overflow-hidden w-full rounded-md z-0",
                className
            )}
        >
            ...
            <div className="relative z-50 flex -translate-y-125 flex-col items-center px-5">
                {children}
            </div>
        </div>
    );
